...
var Node = {
  view({ attrs, state, children }) {
    ...
    ), /* @__PURE__ */ m("svg", { style: { width: "1rem", height: "1rem", marginRight: "0.5rem", paddingLeft: "1px" }, xmlns: "http://www.w3.org/2000/svg", fill: "gray", viewBox: "0 0 16 16" }, attrs.data.Linked.Children.length > 0 ? /* @__PURE__ */ m("circle", { cx: "8", cy: "7", r: "7", fill: "lightgray" }) : null, /* @__PURE__ */ m("circle", { cx: "8", cy: "7", r: "3" })), /* @__PURE__ */ m("span", null, attrs.data.Name)), /* @__PURE__ */ m("div", { style: {
      display: state.expanded ? "flex" : "none",
      flexDirection: "row",
      paddingBottom: "0.25rem"
    } }, /* @__PURE__ */ m("div", { style: { width: "1rem", marginRight: "0.25rem", display: "flex" }, onclick: toggle }, /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid gray", height: "100%", marginLeft: "0.5rem" } })), /* @__PURE__ */ m("div", { style: { flexGrow: "1" } }, attrs.data.Linked.Children.map((id) => /* @__PURE__ */ m(Node, { nodes: attrs.nodes, data: attrs.nodes[id] })))));
  }
};
