...
var Workbench = class {
  ...
  async initialize() {
    ...
    if (nodes.length === 0) {
      const ws2 = this.nodes.new("@workspace");
      ws2.setName("Workspace");
      ws2.setParent(root);
...
var OutlineNode = {
  view({ attrs, state, children }) {
    ...
    ), /* @__PURE__ */ m("svg", { onclick: toggle, ondblclick: zoom, oncontextmenu: (e) => workbench.showMenu(e, { node }), "data-menu": "node", style: {
      cursor: "pointer",
      flexShrink: "0",
      width: "1rem",
      height: "1rem",
...
var OutlineEditor = {
  view({ attrs: { workbench, node }, state }) {
    return /* @__PURE__ */ m("div", { style: { padding: "var(--padding)" } }, node.getChildren().map((n) => /* @__PURE__ */ m(OutlineNode, { key: n.ID, workbench, node: panelNode(n, node.panel) })), /* @__PURE__ */ m(NewNode, { workbench, node }));
  }
};
var NodeEditor = {
  oncreate({ dom }) {
...
var Panel2 = {
  view({ attrs }) {
    ...
    ) : null, /* @__PURE__ */ m(OutlineEditor, { workbench, node })));
  }
};
...
var QuickAdd = {
  view({ attrs: { workbench } }) {
    return /* @__PURE__ */ m("div", { style: {
      ...
      padding: "2rem",
      background: "white"
    } }, /* @__PURE__ */ m("h3", { style: { margin: "0" } }, "Quick Add"), /* @__PURE__ */ m("hr", null), /* @__PURE__ */ m(OutlineEditor, { workbench, node: workbench.quickadd }), /* @__PURE__ */ m("hr", null), /* @__PURE__ */ m("div", { style: { textAlign: "right" } }, /* @__PURE__ */ m("button", { style: { padding: "0.5rem", margin: "0.25rem" }, onclick: () => {
...
var Search = {
  ...
  view({ attrs: { workbench }, state }) {
    ...
    } }, /* @__PURE__ */ m("input", { type: "text", placeholder: "Search", value: state.query, onkeydown, oninput: autocomplete, style: { width: "99%", border: "0", outline: "0", background: "transparent", marginRight: "var(--padding)" } }), state.results.length > 0 ? /* @__PURE__ */ m("div", { class: "results", style: {
      marginTop: "0.25rem",
      overflowX: "hidden",
      overflowY: "auto",
      maxHeight: "400px"
...
var App = {
  view({ attrs: { workbench }, state }) {
    ...
    return /* @__PURE__ */ m("main", { style: { margin: "0", display: "flex", flexDirection: "column", position: "absolute", top: "0", bottom: "0", left: "0", right: "0" } }, /* @__PURE__ */ m("div", { style: { display: "flex", borderBottom: "1px solid var(--dark)" } }, state.open && /* @__PURE__ */ m("div", { style: { width: "200px", display: "flex", padding: "var(--padding)" } }, /* @__PURE__ */ m("div", { style: { flexGrow: "1" } }, /* @__PURE__ */ m("img", { src: "/icon_transparent.png", style: { opacity: "70%", width: "16px", height: "16px" } })), /* @__PURE__ */ m("svg", { onclick: toggle, xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", class: "bi bi-layout-sidebar", viewBox: "0 0 16 16" }, /* @__PURE__ */ m("path", { d: "M0 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3zm5-1v12h9a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H5zM4 2H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h2V2z" }))), /* @__PURE__ */ m("div", { style: { flexGrow: "1", display: "flex" } }, !state.open && /* @__PURE__ */ m("svg", { onclick: toggle, style: { padding: "var(--padding)", borderLeft: "1px solid var(--dark)" }, xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", class: "bi bi-layout-sidebar", viewBox: "0 0 16 16" }, /* @__PURE__ */ m("path", { d: "M0 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3zm5-1v12h9a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H5zM4 2H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h2V2z" })), /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid var(--dark)" } }), /* @__PURE__ */ m("div", { onclick: () => workbench.openToday(), style: { cursor: "pointer", padding: "var(--padding)", display: "flex", alignItems: "center" } }, /* @__PURE__ */ m("svg", { style: { marginRight: "0.25rem", height: "1rem", width: "1rem" }, xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", viewBox: "0 0 16 16" }, /* @__PURE__ */ m("path", { d: "M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H2z" }), /* @__PURE__ */ m("path", { d: "M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4z" }), /* @__PURE__ */ m("text", { "text-anchor": "middle", x: "8", y: "13", style: { fontSize: "0.55rem" } }, new Date().getDate())), /* @__PURE__ */ m("div", null, "Today")), /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid var(--dark)" } }), /* @__PURE__ */ m("div", { onclick: () => workbench.openQuickAdd(), style: { cursor: "pointer", padding: "var(--padding)", display: "flex", alignItems: "center" } }, /* @__PURE__ */ m("svg", { style: { marginRight: "0.25rem", height: "1rem", width: "1rem" }, xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", viewBox: "0 0 16 16" }, /* @__PURE__ */ m("path", { d: "M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09zM4.157 8.5H7a.5.5 0 0 1 .478.647L6.11 13.59l5.732-6.09H9a.5.5 0 0 1-.478-.647L9.89 2.41 4.157 8.5z" })), /* @__PURE__ */ m("div", null, "Quick Add")), /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid var(--dark)" } }), /* @__PURE__ */ m(Search, { workbench }), /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid var(--dark)" } }), /* @__PURE__ */ m("div", { style: { padding: "var(--padding)" } }, /* @__PURE__ */ m("svg", { onclick: (e) => workbench.showMenu(e), "data-menu": "settings", "data-align": "right", style: { cursor: "pointer" }, xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16" }, /* @__PURE__ */ m("path", { d: "M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" }))))), /* @__PURE__ */ m("div", { style: { display: "flex", flexGrow: "1" } }, state.open && /* @__PURE__ */ m("div", { style: { width: "200px", padding: "var(--padding)" } }, workbench.nodes.getRoot().getChildren().map((node) => /* @__PURE__ */ m(NavNode, { node, expanded: true, level: 0, workbench }))), /* @__PURE__ */ m("div", { style: { flexGrow: "1", borderLeft: "1px solid var(--dark)" } }, workbench.panels.map((row) => /* @__PURE__ */ m("div", { style: { display: "flex" } }, row.map((panel) => /* @__PURE__ */ m(Panel2, { workbench, panel })))))), workbench.curtain && /* @__PURE__ */ m("div", { onclick: workbench.curtain.onclick, style: {
      zIndex: "10",
      position: "absolute",
      background: "black",
