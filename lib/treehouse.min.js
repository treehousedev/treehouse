...
var Module = class {
  ...
  getRoot(name) {
    name = name || "@root";
    const node = this.roots().find((root2) => root2.getName() === name);
    if (node === void 0)
      return null;
    return node;
  }
...
var Workspace = class {
  ...
  load(nodes) {
    const root2 = this.module.find("@root");
    if (nodes.length === 0) {
...
var Workbench = class {
  constructor(backend) {
    ...
    this.workspace = new Workspace(
      this.authenticated() ? `treehouse-expanded-${this.backend.auth.currentUser().userID()}` : `treehouse-expanded`
    );
...
var OutlineNode = {
  view({ attrs, state, children }) {
    ...
    } }, /* @__PURE__ */ m("div", { style: { width: "1rem", marginRight: "0.25rem", display: "flex" }, onclick: toggle }, /* @__PURE__ */ m("div", { style: { borderLeft: "1px solid gray", height: "100%", marginLeft: "0.5rem" } })), /* @__PURE__ */ m("div", { style: { flexGrow: "1" } }, node.childCount() > 0 ? node.getChildren().map((n) => /* @__PURE__ */ m(OutlineNode, { key: n.ID, workbench, panel, node: n })) : /* @__PURE__ */ m(NewNode, { workbench, panel, node }))));
  }
};
var NewNode = {
...
var OutlineEditor = {
  view({ attrs: { workbench, panel, node }, state }) {
    return /* @__PURE__ */ m("div", { style: { padding: "var(--padding)" } }, node.getChildren().map((n) => /* @__PURE__ */ m(OutlineNode, { key: n.ID, workbench, panel, node: n })), /* @__PURE__ */ m(NewNode, { workbench, panel, node }));
  }
};
var NodeEditor = {
  oncreate({ dom }) {
