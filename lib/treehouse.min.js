var ke=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var a=(i,e)=>ke(i,"name",{value:e,configurable:!0});var N=(i,e,t,n)=>{for(var o=n>1?void 0:n?Ve(e,t):e,r=i.length-1,s;r>=0;r--)(s=i[r])&&(o=(n?s(e,t,o):s(o))||o);return n&&o&&ke(e,t,o),o};var ye=navigator.userAgent.toLowerCase().indexOf("mac")!==-1;function Y(i){if(!i)return[];let e={backspace:"\u232B",shift:"\u21E7",meta:"\u2318",tab:"\u21B9",ctrl:"\u2303",arrowup:"\u2191",arrowdown:"\u2193",arrowleft:"\u2190",arrowright:"\u2192",enter:"\u23CE"};return i.toLowerCase().split("+").map(be).map(n=>Object.keys(e).includes(n)?e[n]:n)}a(Y,"bindingSymbols");function be(i){return!ye&&i==="meta"?"ctrl":i}a(be,"filterKeyForNonMacMeta");var oe=class{constructor(){this.bindings=[]}registerBinding(e){this.bindings.push(e)}getBinding(e){for(let t of this.bindings)if(t.command===e)return t;return null}evaluateEvent(e){e:for(let t of this.bindings){let n=t.key.toLowerCase().split("+");if(n.pop()===e.key.toLowerCase()){for(let r of["shift","ctrl","alt","meta"]){let s=n.includes(r);if(!ye){if(r==="meta")continue;r==="ctrl"&&(s=n.includes("meta")||n.includes("ctrl"))}let l=e[`${be(r)}Key`];if(!l&&s||l&&!s)continue e}return t}}return null}};a(oe,"KeyBindings");var re=class{constructor(){this.commands={}}registerCommand(e){this.commands[e.id]=e}canExecuteCommand(e,...t){return this.commands[e]?!(this.commands[e].when&&!this.commands[e].when(...t)):!1}executeCommand(e,...t){return new Promise(n=>{let o=this.commands[e].action(...t);n(o)})}};a(re,"CommandRegistry");var ie=class{constructor(){this.menus={}}registerMenu(e,t){this.menus[e]=t}};a(ie,"MenuRegistry");function xe(i,e,t,n){return t?e.disabled||!i.canExecuteCommand(t.id,n):e.disabled}a(xe,"isDisabled");var Ce={view({attrs:{workbench:i,x:e,y:t,items:n,align:o,commands:r,ctx:s}}){let l=a((d,c)=>h=>{h.stopPropagation(),!xe(i,d,c,s)&&(i.closeMenu(),d.onclick&&d.onclick(),c&&i.executeCommand(c.id,s))},"onclick");return m("ul",{class:"menu",style:{margin:"0",display:"inline-block"}},n.filter(d=>!d.when||d.when()).map(d=>{let c="",h,p;return d.command&&(p=r.find(x=>x.id===d.command),h=i.keybindings.getBinding(p.id),c=p.title),d.title&&(c=d.title()),m("li",{onclick:l(d,p),class:xe(i,d,p,s)?"disabled":"",style:{display:"flex"}},m("div",null,c),h&&m("div",{class:"keybindings grow text-right"},Y(h.key).join(" ").toUpperCase()))}))}};var G={onupdate({state:i,dom:e}){let t=e.querySelector(".items").children;i.selected!==void 0&&t.length>0&&t[i.selected].scrollIntoView({block:"nearest"})},oncreate({attrs:i,state:e,dom:t}){i.inputview&&t.querySelector("input")?.focus(),e.selected===void 0&&(e.selected=0)},view({attrs:i,state:e}){e.selected=e.selected===void 0?0:e.selected,e.input=e.input===void 0?i.input||"":e.input,e.items===void 0&&(e.items=[],i.onchange(e));let t=a(o=>{let r=a((s,l)=>(s%l+l)%l,"mod");if(o.key==="ArrowDown")return e.selected===void 0?(e.selected=0,!1):(e.selected=r(e.selected+1,e.items.length),!1);if(o.key==="ArrowUp")return e.selected===void 0&&(e.selected=0),e.selected=r(e.selected-1,e.items.length),!1;if(o.key==="Enter")return e.selected!==void 0&&i.onpick(e.items[e.selected]),!1},"onkeydown"),n=a(o=>{e.input=o.target.value,e.selected=0,i.onchange(e)},"oninput");return m("div",{class:"picker"},i.inputview(t,n,e.input),m("div",{class:"items"},e.items.map((o,r)=>m("div",{class:e.selected===r?"item selected":"item",onclick:()=>i.onpick(o),onmouseover:()=>e.selected=r},i.itemview(o,r)))))}};var Ne={view({attrs:{workbench:i,ctx:e}}){let t=a(d=>(d.title||d.id).replace("-"," ").replace(/(^|\s)\S/g,h=>h.toUpperCase()),"getTitle"),n=a((d,c)=>t(d).localeCompare(t(c)),"sort"),o=a(d=>{i.closeDialog(),i.commands.executeCommand(d.id,e)},"onpick"),r=a(d=>{d.items=l.filter(c=>(c.title||c.id).toLowerCase().includes(d.input.toLowerCase()))},"onchange"),s=a(d=>{let c=i.keybindings.getBinding(d.id);return c?Y(c.key).join(" ").toUpperCase():""},"getBindingSymbols"),l=Object.values(i.commands.commands).filter(d=>!d.hidden).filter(d=>i.canExecuteCommand(d.id,e)).sort(n);return m("div",{class:"palette"},m(G,{onpick:o,onchange:r,inputview:(d,c)=>m("div",null,m("input",{style:{width:"98%"},type:"text",onkeydown:d,oninput:c,placeholder:"Enter command..."})),itemview:d=>m("div",{class:"flex"},m("div",null,t(d)),m("div",{class:"keybindings grow text-right"},s(d)))}))}};function Q(i,e){return i.value&&i.value[e]instanceof Function}a(Q,"hasHook");function J(i,e,...t){if(Q(i,e))return i.value[e].apply(i.value,t)}a(J,"triggerHook");function H(i,e){for(let t of i.components)if(Q(t,e))return!0;return!1}a(H,"objectHas");function se(i,e,...t){for(let n of i.components)if(Q(n,e))return n.value[e].apply(n.value,t)}a(se,"objectCall");function X(i,e,...t){let n=[];for(let o of i.components)Q(o,e)&&n.push(o.value);return n}a(X,"componentsWith");function B(i){return H(i,"objectChildren")}a(B,"objectManaged");var ge={};function S(i){ge[K(i)]=i}a(S,"component");function K(i){return i.prototype===void 0&&(i=i.constructor),`treehouse.${i.name}`}a(K,"componentName");function Z(i){return typeof i=="string"?ge[i]:ge[K(i)]}a(Z,"getComponent");function Se(i,e){let t=new(Z(i));return t.fromJSON instanceof Function?t.fromJSON(e):Object.defineProperties(t,Object.getOwnPropertyDescriptors(e)),t}a(Se,"inflateToComponent");function De(i){if(i===void 0)return;if(!Z(i))return structuredClone(i);let t=JSON.parse(JSON.stringify(i)||""),n=new i.constructor;return n.fromJSON instanceof Function?n.fromJSON(t):Object.defineProperties(n,Object.getOwnPropertyDescriptors(t)),n}a(De,"duplicate");var C=class{constructor(){}onAttach(e){this.object=e.parent,this.object.setAttr("view","document")}handleIcon(e=!1){return m("svg",{xmlns:"http://www.w3.org/2000/svg",width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"node-bullet"},m("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),m("polyline",{points:"14 2 14 8 20 8"}),m("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),m("line",{x1:"16",y1:"17",x2:"8",y2:"17"}),m("polyline",{points:"10 9 9 9 8 9"}))}toJSON(e){return{}}static initialize(e){e.commands.registerCommand({id:"make-document",title:"Make Document",action:t=>{if(!t.node)return;let n=new C;t.node.addComponent(n),t.node.changed(),e.executeCommand("zoom",t)}})}};a(C,"Document"),C=N([S],C);var L=class{constructor(){this.text=""}editor(){return ze}static initialize(e){e.commands.registerCommand({id:"add-description",title:"Add Description",when:t=>!(!t.node||t.path.previous&&B(t.path.previous)||t.node.hasComponent(L)),action:(t,n)=>{let o=new L;t.node.addComponent(o),t.node.changed()}}),e.commands.registerCommand({id:"remove-description",title:"Remove Description",when:t=>!t.node||t.path.previous&&B(t.path.previous)?!1:!!t.node.hasComponent(L),action:(t,n)=>{t.node.removeComponent(L),t.node.changed()}})}};a(L,"Description"),L=N([S],L);var ze={view({attrs:{node:i}}){let e=a(n=>{let o=i.getComponent(L);o.text=n.target.value,i.changed()},"oninput"),t=a(n=>{i.getComponent(L).text===""&&i.removeComponent(L),i.changed()},"onblur");return m("input",{class:"node-description",placeholder:"Add Description",type:"text",value:i.getComponent(L).text,onblur:t,oninput:e})}};var U={view({attrs:{workbench:i,path:e,onkeydown:t,oninput:n,disallowEmpty:o,editValue:r,placeholder:s},state:l}){let d=e.node,c=r?"value":"name",h=a(()=>c==="name"?H(d,"displayName")?se(d,"displayName",d):d.name:d[c]||"","display"),p=a(()=>{l.initialValue=d[c],i.context.node=d,i.context.path=e},"onfocus"),x=a(()=>d[c],"getter"),A=a((b,g)=>{d.isDestroyed||(o&&b.length===0?d[c]=l.initialValue:d[c]=b),g&&(i.context.node=null)},"setter");d.raw.Rel==="Fields"&&(s=r?"Value":"Field");let v=`input-${e.id}-${d.id}`;c==="value"&&(v=v+"-value");let w=Je;d.parent&&d.parent.hasComponent(C)&&window.Editor&&(w=Qe);let f;return d.hasComponent(L)&&(f=d.getComponent(L)),m("div",{class:"node-editor flex flex-col"},m(w,{id:v,getter:x,setter:A,display:h,onkeydown:t,onfocus:p,oninput:n,placeholder:s,workbench:i,path:e}),f?m(f.editor(),{node:d}):null)}},Qe={oncreate({dom:i,state:e,attrs:{id:t,onkeydown:n,onfocus:o,onblur:r,oninput:s,getter:l,setter:d,display:c,placeholder:h}}){let p=e.editing?e.buffer:c?c():l(),x=a(f=>{f.key==="Enter"&&(f.preventDefault(),f.stopPropagation())},"defaultKeydown"),A=a(f=>{o&&o(f),e.editing=!0,e.buffer=l()},"startEdit"),v=a(f=>{e.editing&&(e.editing=!1,d(e.buffer,!0),e.buffer=void 0),r&&r(f)},"finishEdit"),w=a(f=>{e.buffer=f.target.value,d(e.buffer,!1),s&&s(f)},"edit");e.editor=new window.Editor(i,p,h),e.editor.onblur=v,e.editor.onfocus=A,e.editor.oninput=w,e.editor.onkeydown=n||x,i.editor=e.editor,i.id=t},onupdate({dom:i,state:e,attrs:{getter:t,display:n}}){e.editor.value=e.editing?e.buffer:n?n():t()},view(){return m("div",{class:"text-editor"})}},Je={oncreate({dom:i,attrs:e}){let t=i.querySelector("textarea"),n=t.offsetHeight,o=i.querySelector("span");this.updateHeight=()=>{o.style.width=`${Math.max(t.offsetWidth,100)}px`,o.innerHTML=t.value.replace(`
